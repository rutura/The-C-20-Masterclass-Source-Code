...
*/
template<> struct fmt::formatter<CivilEngineer>
{
  constexpr auto parse(format_parse_context &ctx) { return ctx.begin(); }

  template<typename FormatContext> auto format(const CivilEngineer &obj, FormatContext &ctx) const
  {
    return format_to(ctx.out(),
      "CivilEngineer [ Full name: {}, age: {}, address: {}, contract_count: {}, speciality: {}]",
      obj.get_full_name(),
      obj.get_age(),
      obj.get_address(),
