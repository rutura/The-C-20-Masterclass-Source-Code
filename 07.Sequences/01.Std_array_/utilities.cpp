...
void do_work()
{
  ...
  */
  ...
  //5. Accessing the first and last elements
  /*
      std::array<int, 5> arr = {1, 2, 3, 4, 5};
  ...
  */
  ...
  //6. Multi-dimensional: 2D array (3x2)
  /*
  ...
  */
  ...
  for (const auto &element : arr1) { fmt::print("{} ", element); }
  fmt::print("\n");

  fmt::println("Original arr2: ");
  for (const auto &element : arr2) { fmt::print("{} ", element); }
  fmt::print("\n");
