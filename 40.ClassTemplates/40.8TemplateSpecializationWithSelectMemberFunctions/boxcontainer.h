...
template<typename T = int, typename V = int> class BoxContainer
{
...
template<typename T, typename V> inline std::ostream &operator<<(std::ostream &out, const BoxContainer<T, V> &operand)
{
...
template<typename T, typename V> struct fmt::formatter<BoxContainer<T, V>>
{
  constexpr auto parse(format_parse_context &ctx) { return ctx.begin(); }
  template<typename FormatContext> auto format(const BoxContainer<T, V> &obj, FormatContext &ctx)
  {
    memory_buffer buf;
...
template<typename T, typename V> BoxContainer<T, V>::BoxContainer(size_t capacity)
{
...
template<typename T, typename V> BoxContainer<T, V>::BoxContainer(const BoxContainer<T, V> &source)
{
  // Set up the new box
...
template<typename T, typename V> BoxContainer<T, V>::~BoxContainer() { delete[] m_items; }
...
template<typename T, typename V> void BoxContainer<T, V>::expand(size_t new_capacity)
{
...
template<typename T, typename V> void BoxContainer<T, V>::add(const T &item)
{
...
template<typename T, typename V> bool BoxContainer<T, V>::remove_item(const T &item)
{
...
template<typename T, typename V> size_t BoxContainer<T, V>::remove_all(const T &item)
{
...
template<typename T, typename V> void BoxContainer<T, V>::operator+=(const BoxContainer<T, V> &operand)
{
...
template<typename T, typename V> void BoxContainer<T, V>::operator=(const BoxContainer<T, V> &source)
{
  T *new_items;
