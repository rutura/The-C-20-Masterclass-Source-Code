...
// dozen separate bool parameters around. An enum class (earlier in this
// chapter) gives each option a readable name, and giving each one its own
// bit means several can be combined into a single value with |.
