...
/*
export void overload_plus_operator_as_member(){
	Point p1(10, 10);
	Point p2(20, 20);
...
/*
export void overload_plus_operator_as_non_member(){
	Point p1(10, 10);
	Point p2(20, 20);
...
/*
export void overload_subscript_operator(){
	Point p1(10, 20);
...
/*
export void overload_subscript_reading_writing(){
	Point p1(10, 20);
...
export void overload_subscript_operator_for_collection_types(){
	Scores math("Math");
	math.print_info();
