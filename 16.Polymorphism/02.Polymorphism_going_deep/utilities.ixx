...
import override_keyword;
import override_overload_and_hide;
import polymorphism_diff_levels;
...
export void override_keyword_demo(){
  ...
  for (override_keyword::Shape *shape_ptr : shapes3) {
	shape_ptr->draw(); 
  }
}


export void overloading_overriding_and_hiding_demo(){
...
export void polymorphism_diff_levels_demo(){
	...
	polymorphism_diff_levels::Pigeon pigeon2("white", "pigeon2");// Putting pigeon in felines will result in compiler error
...
export void polymorphism_with_static_members_demo(){
