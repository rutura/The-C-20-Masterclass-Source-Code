...
| Lecture Name                              | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|-------------------------------------------|------------|------------------------|----------|
| 11.1 Enums, Type Aliases                  | ❌         | ❌                     | ❌       |
| 11.2 Blueprints, Classes                  | ❌         | ❌                     | ❌       |
| 11.3 Class Members and Access             | ❌         | ❌                     | ❌       |
| 11.4 Classes, Objects, and Const          | ❌         | ❌                     | ❌       |
| 11.5 Constructors Up Close                | ❌         | ❌                     | ❌       |
| 11.6 More Initialization                  | ❌         | ❌                     | ❌       |
| 11.7 Friends                             | ❌         | ❌                     | ❌       |
| 11.8 Static Members                       | ❌         | ❌                     | ❌       |
...
| Lecture Name                              | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|-------------------------------------------|------------|------------------------|----------|
| 13.1 Compilation Model, Declarations, Definitions | ❌         | ❌                     | ❌       |
| 13.2 Linkage                             | ❌         | ❌                     | ❌       |
...
| Lecture Name                              | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|-------------------------------------------|------------|------------------------|----------|
| 15.1 Operator Overloading Basics         | ❌         | ❌                     | ❌       |
| 15.2 Stream Operators                    | ❌         | ❌                     | ❌       |
| 15.3 Compound Operators                  | ❌         | ❌                     | ❌       |
| 15.4 Operator Overloading and Type Conversions | ❌         | ❌                     | ❌       |
| 15.5 Prefix and Postfix Operators        | ❌         | ❌                     | ❌       |
| 15.6 Copy Operators                      | ❌         | ❌                     | ❌       |
| 15.7 Functors                           | ❌         | ❌                     | ❌       |
| 15.8 Logical Operators                   | ❌         | ❌                     | ❌       |
...
| Lecture Name                              | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|-------------------------------------------|------------|------------------------|----------|
| 17.1 Polymorphism Basics                 | ❌         | ❌                     | ❌       |
| 17.2 Polymorphism Going Deep             | ❌         | ❌                     | ❌       |
| 17.3 Final Access Specifiers and Virtual | ❌         | ❌                     | ❌       |
...
| Lecture Name                              | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|-------------------------------------------|------------|------------------------|----------|
| 18.1 Exceptions Basics                   | ❌         | ❌                     | ❌       |
| 18.2 Exceptions and Objects              | ❌         | ❌                     | ❌       |
...
| Lecture Name                              | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|-------------------------------------------|------------|------------------------|----------|
| 20.1 Templates Basics                    | ❌         | ❌                     | ❌       |
| 20.2 Template Intantialization and spec  | ❌         | ❌                     | ❌       |
| 20.3 Variable Templates and Aliases      | ❌         | ❌                     | ❌       |
| 20.4 Templates and Friendship            | ❌         | ❌                     | ❌       |
| 20.5 RecursionVariadicTemplatesFoldExpr  | ❌         | ❌                     | ❌       |
| 20.6 Concepts                            | ❌         | ❌                     | ❌       |
| 20.7 Class Templates Concepts            | ❌         | ❌                     | ❌       |
...
| Lecture Name                      | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|-----------------------------------|------------|------------------------|----------|
| 22.01Function_pointers_callbacks   | ❌         | ❌                     | ❌       |
| 22.02Functors                      | ❌         | ❌                     | ❌       |
| 22.03lambdas                      | ❌         | ❌                     | ❌       |
| 22.04_Std_function                | ❌         | ❌                     | ❌       |
...
| Lecture Name                                         | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|------------------------------------------------------|------------|------------------------|----------|
| 23.01Container_Iterators_basics                     |     ❌     | ❌                     | ❌       |
| 23.02Iterator_adaptors                               | ❌         |                      | ❌       |
| 23.03Ranges_library                                 |  ❌        | ❌                     | ❌       |
...
| Lecture Name                  | Visual C++ | GCC 14.2.0 (iostreams) | Clang 18 |
|-------------------------------|------------|------------------------|----------|
| 25.01Coroutines_basics        | ❌         | ❌                     | ❌       |
| 25.02Third_party_coroutines   | ❌         | ❌                     | ❌       |
