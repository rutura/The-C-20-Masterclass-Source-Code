/*
    This file contains code that exemplifies the building process for input iterators: 
        ...
        . common requirements for all iterators: 
            ...
            . destructible, 
            . prefix, 
            . postfix incrementable.

        . The needed operators are: 
            . operator* : Dereference operator
            . operator++ : Increment operator
            . operator!= : Inequality operator
            . operator== : Equality operator
        . These iterators are used by algorithms such as std::find and std::accumulate.
*/
...
*/
inline void read_lines_from_file()
{

  //Set up the file path. Adapt this to your local environment.
  std::ifstream file(
    "D:\\Sandbox\\The-C-20-Masterclass-Source-Code\\23.STL_containers_iterators_ranges\\23.05Custom_container_iterators\\data.txt");
