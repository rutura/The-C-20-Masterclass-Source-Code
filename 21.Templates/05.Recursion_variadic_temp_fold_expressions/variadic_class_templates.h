...
template<typename... Types> class MyTuple;// Forward declaration
...
template<typename Head, typename... Tail> class MyTuple<Head, Tail...> : public MyTuple<Tail...>
{
  Head value;

public:
  // Constructor initializes the current value and passes the rest to the base class
  MyTuple(Head v, Tail... tail)
    : MyTuple<Tail...>(tail...), value(v) {}
