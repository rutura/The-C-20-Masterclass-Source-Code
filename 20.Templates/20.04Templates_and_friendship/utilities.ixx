...
export void templates_and_friendship_02_demo(){
	...
	templates_and_friendship_02::print_point<double>(p);	//The template parameter could be anything here. It's not used anyway.
...
export void templates_and_friendship_03_demo(){
	...
	//templates_and_friendship_03::print_point<int>(p);	// print_point<int> can access the private members of Point<int>

	templates_and_friendship_03::Canvas<int> canvas; // If it was double, you'd get a compiler error.
...
export void templates_and_friendship_04_demo(){
	...
	//print_point(p2);	// print_point can't access the private members of Point<double>
}
