...
bool operator<(int left_operand, const Number &right_operand) { return (left_operand < right_operand.m_wrapped_int); }
bool operator<(const Number &left_operand, int right_operand) { return (left_operand.m_wrapped_int < right_operand); }
