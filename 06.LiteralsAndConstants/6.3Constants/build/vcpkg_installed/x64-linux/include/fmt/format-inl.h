...
template<typename F> inline auto operator==(basic_fp<F> x, basic_fp<F> y) -> bool { return x.f == y.f && x.e == y.e; }
...
namespace dragonbox {
  ...
  template<> struct cache_accessor<float>
  {
    ...
    static auto get_cached_power(int k) noexcept -> uint64_t
    {
      ...
      static constexpr const uint64_t pow10_significands[] = { 0x81ceb32c4b43fcf5,
        0xa2425ff75e14fc32,
        0xcad2f7f5359a3b3f,
        0xfd87b5f28300ca0e,
        0x9e74d1b791e07e49,
...
FMT_FUNC bool write_console(int fd, string_view text)
{
  ...
  return WriteConsoleW(
           reinterpret_cast<void *>(_get_osfhandle(fd)), u16.c_str(), static_cast<dword>(u16.size()), nullptr, nullptr)
         != 0;
}
