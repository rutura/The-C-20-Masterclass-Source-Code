...
// Improves how we collect the name and the continuation prompt
void fortune_teller_version_5()
{
  std::vector<std::string> predictions{
    "a lot of kinds running in the backyard!",
