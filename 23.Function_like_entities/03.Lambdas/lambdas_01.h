...
inline std::string &modify(std::string &str_param, char (*modifier)(const char &))
{
...
inline box::BoxContainer<std::string> &modify(box::BoxContainer<std::string> &sentence, char (*modifier)(const char &))
{
