...
DoubleContainer::~DoubleContainer() { delete[] m_items; }
...
void DoubleContainer::stream_insert(fmt::basic_memory_buffer<char> &out) const
{
  fmt::memory_buffer buf;
  format_int_pointer_array(buf, m_items, m_size);
  format_to_n(std::back_inserter(out),
    out.capacity(),
    "BoxContainer : [size: {}, capacity: {}, items: {}]",
    m_size,
    m_capacity,
    fmt::to_string(buf));
}
