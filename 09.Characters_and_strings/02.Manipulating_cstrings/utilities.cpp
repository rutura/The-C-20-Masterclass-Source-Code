...
void cstring_find_first_occurence_version_1()
{
...
void cstring_find_first_occurence_version_2()
{
...
void cstring_find_last_occurence()
{
  // Find last occurence
  // CODE STOLEN FROM THE DOCS :
  fmt::println("");
  ...
  if (output) fmt::println("{}", output + 1);//+1 because we want to start printing past
  // the character found by std::strrchr.
}

void cstring_concatenation_version_1()
{
  // Concatenation
  fmt::println("");
...
void cstring_concatenation_version_2()
{
  // More concatenation
  fmt::println("");
