...
void use_dog_v2(std::shared_ptr<Dog> &dog)
{
  ...
  fmt::println(
    "shared_ptr passed by non const reference (dog name changed in function) , dog_name : {}", dog->get_name());
...
export void unique_pointer_from_shared_pointer(){
...
export void shared_pointers_with_arrays(){
...
//#4: shared pointers as function parameters and return types
export void shared_pointers_as_function_parameters_and_return_types(){
