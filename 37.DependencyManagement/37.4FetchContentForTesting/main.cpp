...
// Same tests as 36.4AssertionsAndSections -- this lecture's focus is the
// CMakeLists.txt. There, Catch2 came from the system's installed package
// (apt/vcpkg/whatever the machine already had). Here, FetchContent pulls
// the exact same version of Catch2 straight from its GitHub repo, so every
// student (and CI machine) builds against an identical, pinned Catch2 --
// no "works on my machine because I have a newer/older Catch2 installed."
