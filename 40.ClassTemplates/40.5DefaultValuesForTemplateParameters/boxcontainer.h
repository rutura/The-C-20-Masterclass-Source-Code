...
template<typename T = int, size_t maximum = 10> class BoxContainer
{
...
inline std::ostream &operator<<(std::ostream &out, const BoxContainer<T, maximum> &operand)
{
  ...
  out << "BoxContainer : [ size :  " << operand.size() << ", capacity : " << operand.capacity()
      << ", maximum_nttp : " << maximum << ", items : ";

  for (size_t i{ 0 }; i < operand.size(); ++i) { out << operand.get_item(i) << " "; }
  out << "]";
...
template<typename T, size_t maximum> struct fmt::formatter<BoxContainer<T, maximum>>
{
  constexpr auto parse(format_parse_context &ctx) { return ctx.begin(); }
  template<typename FormatContext> auto format(const BoxContainer<T, maximum> &obj, FormatContext &ctx)
  {
    memory_buffer buf;
...
template<typename T, size_t maximum> BoxContainer<T, maximum>::BoxContainer(size_t capacity)
{
...
template<typename T, size_t maximum> BoxContainer<T, maximum>::BoxContainer(const BoxContainer<T, maximum> &source)
{
  // Set up the new box
...
template<typename T, size_t maximum> BoxContainer<T, maximum>::~BoxContainer() { delete[] m_items; }
...
template<typename T, size_t maximum> void BoxContainer<T, maximum>::expand(size_t new_capacity)
{
...
template<typename T, size_t maximum> void BoxContainer<T, maximum>::add(const T &item)
{
...
template<typename T, size_t maximum> bool BoxContainer<T, maximum>::remove_item(const T &item)
{
...
template<typename T, size_t maximum> size_t BoxContainer<T, maximum>::remove_all(const T &item)
{
...
template<typename T, size_t maximum> void BoxContainer<T, maximum>::operator+=(const BoxContainer<T, maximum> &operand)
{
...
template<typename T, size_t maximum> void BoxContainer<T, maximum>::operator=(const BoxContainer<T, maximum> &source)
{
  T *new_items;
