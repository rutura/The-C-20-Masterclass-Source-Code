...
export void constructor_default_parameters(){
	Cylinder c1(4);
...
export void constructor_initializer_lists(){
	Cylinder c1(5);
...
export void explicit_constructors(){
...
export void constructor_delegation(){
	Square s1(100.0);
}

// #5: Copy constructors
export void copy_constructors(){
...
export void arrays_store_copies(){
...
export void deleted_constructors(){
