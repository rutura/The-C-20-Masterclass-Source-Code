...
int main() {
    ...
    */
    ...
    /*
        Exercise 8 - bringing in the image project from 6.20, and adding
        a new shape to it
        ...
        1) Copy image.h and image.cpp from
           06.Functions/6.20ProjectFetchContent into this folder. Those
        ...
        2) Update THIS folder's CMakeLists.txt so it builds with the new
           files. Copy the FetchContent block from 6.20's CMakeLists.txt
        ...
        4) In main(), build a 400x300 image:
             ...
             - keep calling draw_border(...) exactly as in 6.20, so the
             ...
             - write_png("image.png", ...) to save it, same as 6.20
