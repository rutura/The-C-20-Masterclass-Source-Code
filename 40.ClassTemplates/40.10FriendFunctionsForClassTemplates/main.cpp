...
template<typename T> class TemplateClass;// forward declare to make function declaration possible
...
public:
  ...
  void do_something(const T a, T b) { fmt::println("Doing something with {} and {}", a, b); }

private:
  T m_var;
};

template<typename T> void some_func(TemplateClass<T> param)
{
